...
bool ParticleArrayLoader::getParticleCountFromFirstFile(std::string filePath, int& particleCount)
{
	Partio::ParticlesDataMutable* particlesData = Partio::read(filePath.c_str());
...
bool ParticleArrayLoader::loadParticlesFromFile(std::vector<Particle> &particleArray,std::string filePath)
{
